...
function struct_anim:animation/search/candidate_by_author with storage struct_anim:id root.search
function struct_anim:dynamic_book/state/quickstart/_make_page with storage struct_anim:animation_condidates root.search.animation.controller
