...
execute unless data storage struct_anim:animations root.animators[-1].locked run function struct_anim:dynamic_book/state/edit_frames/_add_component {path: "frames/new"}
