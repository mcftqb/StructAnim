# Uses animator selected [-1]
data modify storage struct_anim:utils root.ctx.update_animation_controller set from storage struct_anim:animations root.animators[-1].controller
