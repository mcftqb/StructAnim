...
execute store result storage struct_anim:animations root.animators[0].placement.x int 1 run scoreboard players get #VAR_0 struct_anim.int
...
scoreboard players operation #VAR_0 struct_anim.int += #VAR_1 struct_anim.int
execute store result storage struct_anim:animations root.animators[0].placement.y int 1 run scoreboard players get #VAR_0 struct_anim.int
...
scoreboard players operation #VAR_0 struct_anim.int += #VAR_1 struct_anim.int
execute store result storage struct_anim:animations root.animators[0].placement.z int 1 run scoreboard players get #VAR_0 struct_anim.int

$data modify storage struct_anim:animations root.animators[0].placement.Dimension set from entity @p[name="$(author)"] Dimension

function struct_anim:itemset/animation/edition/give with storage struct_anim:animations root.animations[0]