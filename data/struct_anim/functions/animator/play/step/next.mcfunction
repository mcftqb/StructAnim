$execute unless data storage struct_anim:animations animators[{id: "$(id)", reversed: true}] store result score #VAR_STEP struct_anim.int run data get storage struct_anim:animations animators[{id: "$(id)"}].step 1
$execute if data storage struct_anim:animations animators[{id: "$(id)", reversed: true}] store result score #VAR_STEP struct_anim.int run data get storage struct_anim:animations animators[{id: "$(id)"}].step -1
