...
$execute as @p[name="$(author)"] at @s run function struct_anim:itemset/animation/new/area_marking/_give with storage struct_anim:utils root.ctx.animation.new_area_marking.give
