...
execute unless score #IS_OPERATION_SUCCEESSFUL struct_anim.id matches 1 run function struct_anim:debug {text: "Player ID not found", trace: "id/player/_get_name"}
