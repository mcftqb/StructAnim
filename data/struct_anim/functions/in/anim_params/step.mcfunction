...
tellraw @s [{"text": "Animation(", "color": "gold"}, {"nbt":"root.animators[-1].id", "storage": "struct_anim:animations"}, ").step successfully set to ", {"nbt":"root.animators[-1].step", "storage": "struct_anim:animations", "bold": true}]