...
tellraw @s [{"text": "Animation(", "color": "gold"}, {"nbt":"root.animators[-1].id", "storage": "struct_anim:animations","font": "uniform","bold": true}, ").reversed successfully set to ", {"nbt":"root.animators[-1].reversed", "storage": "struct_anim:animations", "bold": true}]